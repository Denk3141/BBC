...
public class BaseTest {
   ...
   public void tearDown() {
    ...
    public ContactBBCNewsPage getContactBBCNewsPage() {return new ContactBBCNewsPage(getDriver());}
    ...
    public YourCoronavirusStoriesPage getYourCoronavirusStoriesPage() {return new YourCoronavirusStoriesPage(getDriver());}
